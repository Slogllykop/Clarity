        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-zinc-900 border border-zinc-800 rounded-lg">
            <p className="text-xs text-gray-400 leading-relaxed">
              <strong className="text-accent">Privacy:</strong> All data stays local on your device.
              No information is sent to any server. Notifications are triggered automatically based
